/**
 * General – Scroll reveal, sticky header, floating lawyer card, lawyer tooltip
 */
(function () {
  function initReveal() {
    var sections = document.querySelectorAll('.design-general .reveal-section');
  ...
  function setHeroLawyerPresence() {
    ...
    var tagline = document.querySelector('.design-general .tagline');
  ...
  function initLawyerTooltip() {
    ...
    var profileText = document.getElementById('profile-text');
    var waFloat = document.querySelector('.whatsapp-float');
    var triggers = document.querySelectorAll('.design-general #profile-photo, .design-general #profile-title, .design-general .profile-content, .design-general #header-lawyer-photo, .design-general #hero-lawyer-name, .design-general .hero-lawyer-presence');
    var hideTimer;
