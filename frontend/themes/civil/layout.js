/**
 * Civil – Sticky CTA bar, scroll reveal, header scroll, floating lawyer card, lawyer tooltip
 */
(function () {
  ...
  function initReveal() {
    var sections = document.querySelectorAll('.design-civil .reveal-section');
  ...
  function setHeroLawyerPresence() {
    ...
    var tagline = document.querySelector('.design-civil .tagline');
  ...
  function initLawyerTooltip() {
    ...
    var profileText = document.getElementById('profile-text');
    var waFloat = document.querySelector('.whatsapp-float');
    var triggers = document.querySelectorAll('.design-civil #profile-photo, .design-civil #profile-title, .design-civil .profile-content, .design-civil #header-lawyer-photo, .design-civil #hero-lawyer-name, .design-civil .hero-lawyer-presence');
    var hideTimer;
