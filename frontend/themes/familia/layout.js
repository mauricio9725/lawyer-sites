/**
 * Familia – Scroll reveal, sticky header, floating lawyer card, lawyer tooltip
 */
(function () {
  function initReveal() {
    var sections = document.querySelectorAll('.design-familia .reveal-section');
  ...
  function setHeroLawyerPresence() {
    ...
    var tagline = document.querySelector('.design-familia .tagline');
  ...
  function initLawyerTooltip() {
    ...
    var profileText = document.getElementById('profile-text');
    var waFloat = document.querySelector('.whatsapp-float');
    var triggers = document.querySelectorAll('.design-familia #profile-photo, .design-familia #profile-title, .design-familia .profile-content, .design-familia #header-lawyer-photo, .design-familia #hero-lawyer-name, .design-familia .hero-lawyer-presence');
    var hideTimer;
